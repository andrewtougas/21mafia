<template>
  <section class="uk-section uk-section-small high-scores">
    <h2>Highest Team Scores</h2>
    <div class="high-scores__wrapper">
      <table class="uk-table uk-table-striped uk-table-small">
        <thead>
          <tr>
            <th>#</th>
            <th>Team</th>
            <th class="uk-text-right">Points</th>
        ...
        <tbody>
          <tr :key="index" v-for="(score, index) in orderedScores">
            ...
            <td class="uk-text-right">{{ score.score }}</td>
